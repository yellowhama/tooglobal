...
- `HANDOFF_3STAGE_PIPELINE.md` — 3-stage storyboard/panel pipeline spec + what to implement next
...
- `workflows/storyboard_quick.json` — legacy all-in-one (CN + IP-Adapter + upscale) baseline
- `workflows/golden_chibi.json` — character generation workflow (IP-Adapter route)
- `workflows/img2img_refine.json` — optional img2img refinement workflow
...
- `workflows/flux_lots_of_tweaks.json` — detailers-heavy experimental workflow
